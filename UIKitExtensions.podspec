...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Voidilov/UIKitExtensions'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Voidilov' => 'voidilov@gmail.com' }
  s.source           = { :git => 'https://github.com/Voidilov/UIKitExtensions.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'UIKitExtensions' => ['UIKitExtensions/Assets/*.png']
  # }
